MEMORY
{
   BEGIN            : origin = 0x082000, length = 0x000002  // App entry — sectors 0-7 reserved for boot manager
   ...
   RAMLS8           : origin = 0x014000, length = 0x004000  // When configured as CLA program use the address 0x4000
  // RAMLS9           : origin = 0x016000, length = 0x002000  // When configured as CLA program use the address 0x6000
   ...
   /* Sectors 0-7 (0x080000-0x081FFF) reserved for boot manager */
...
SECTIONS
{
   ...
   /* THD FFT Buffers */
   RFFTdata1 : > RAMLS8, ALIGN(1024)
   RFFTdata2 : > RAMLS8, ALIGN(8)
   RFFTdata3 : > RAMLS8, ALIGN(8)
   RFFTdata4 : > RAMLS8, ALIGN(8)
