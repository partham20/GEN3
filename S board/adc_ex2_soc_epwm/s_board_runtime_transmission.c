...
const uint8_t SBOARD_VERSION = 10;
...
void sendSBoardBranchFramesToMBoard(void)
{
    ...
    for (branchIndex = 0; branchIndex < NUM_BRANCHES; branchIndex++)
    {
        ...
        // DEBUG: hardcode kW to 1000 at TX point to verify M-Board CAN path
     //   p->branchKW = 1000;
        ...
        // Bytes 10-11: Current THD
        pack16(frameData, &idx, p->branchCurrentTHD);
        // Bytes 12-13: Voltage THD
