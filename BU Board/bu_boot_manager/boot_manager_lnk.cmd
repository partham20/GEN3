/*
 * boot_manager_lnk.cmd  —  BU-Board boot manager
 *
 * Linker command file for the BU board boot manager.
 * Constrains ALL flash code/data to Bank 0 Sectors 0-7 (8KB).
 * Flash API runs from RAM (mandatory — cannot execute from flash
 ...
 *   0x082000+          APPLICATION (loaded separately via OTA or JTAG)
 */
